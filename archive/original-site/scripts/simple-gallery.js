...
class SimpleGalleryGenerator {
  constructor() {
    ...
    this.imagesDir = path.join(this.baseDir, 'assets', 'images');
    this.caseStudiesDir = path.join(this.baseDir, 'case-studies');
    this.logosDir = path.join(this.baseDir, 'assets', 'images', 'logos');
